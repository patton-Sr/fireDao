...
// File: contracts/interface/ICityNodeTreasury.sol



pragma solidity ^0.8.0;

interface ICityNodeTreasury{
...
// File: contracts/CityNodeTreasury.sol
...
contract cityNode is ERC1155, Ownable {
 ...
 function joinCityNode(uint256 cityNodeNum) public {
    ...
    require(IFireSoul(fireSoul).checkIsNotFidUser(msg.sender) || whiteUser[msg.sender], "you haven't FID,plz burn fireseed to create"); 
