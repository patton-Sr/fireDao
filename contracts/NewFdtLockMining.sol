...
contract FdtLockMining is Ownable {
    ...
    */
    ...
    constructor(FirePassport _fp,address _fireSoul,address _fdt,address _flm,address _sbt001, address _sbt006) {
    ...
    function setSbt006(address _sbt006) public onlyOwner {
        sbt006 = _sbt006;
    }
 ...
 function yield(address _user, uint256 _fdtAmount) public view returns (uint256) {
    ...
    function lockFdt(uint256 _several,uint256 _FdtAmount) public {
        ...
        require(
            ...
            uint256 amount0 = _FdtAmount * Weights[_several];
            uint256 amount1 = _FdtAmount * Weights[_several];
            ISbt001(sbt001).mint(receiver, amount0 );
            ISbt006(sbt006).mint(receiver, amount1 );
            TransferHelper.safeTransferFrom(fdt,msg.sender,address(this),_FdtAmount);
    ...
    function Claim(uint256 _amount,uint256 _id) public {
        ...
        require(userlockDetails[msg.sender][_id].fdtAmount >= _amount,'Insufficient lp tokens');
        ...
        (
                ...
                IFireSoul(fireSoul).checkFIDA(msg.sender),
                msg.sender,
                userlockDetails[msg.sender][_id].fdtAmount,
                block.timestamp
        );
    }
