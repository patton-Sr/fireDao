...
contract autoLp is Ownable {
    ...
    address private constant UNISWAP_ROUTER_ADDRESS = 0x2863984c246287aeB392b11637b234547f5F1E70;
    ...
    constructor(address _reputation,address _fdt) {
        ...
        IERC20(_fdt).approve(address(UNISWAP_ROUTER_ADDRESS),100000000 *10 ** 18);
    ...
    function backToken() public onlyOwner {
        TransferHelper.safeTransfer(uniswapV2Router.WETH(),msg.sender , IERC20(uniswapV2Router.WETH()).balanceOf(address(this)));
    }
  ...
  function buyAndAddLiquidity() external {
        ...
        uint tokenBalance = IERC20(fdt).balanceOf(address(this));
        TransferHelper.safeTransfer(uniswapV2Router.WETH(), msg.sender, reward);
        // Add liquidity to Uniswap
        IERC20(fdt).safeIncreaseAllowance(UNISWAP_ROUTER_ADDRESS, tokenBalance);
