...
contract LpLockMining is Ownable {
    ...
    */
    ...
    function lockLp(uint256 _several,uint256 _LPAmount) public {
        ...
        require(IERC20(sbt001).balanceOf(address(this))>0&& IERC20(sbt005).balanceOf(address(this))>0, 'Insufficient contract sbt quota');
        require(
                _several == 0 ||
                _several == 1 || 
                _several == 3 ||
            ...
            // IERC20(sbt001).transfer(receiver,  amount0 * Weights[_several]);
            // IERC20(sbt005).transfer(receiver, amount1);
            // TransferHelper.safeTransfer(sbt001, receiver, amount0 * Weights[_several]);
            // TransferHelper.safeTransfer(sbt005, receiver, amount1);
