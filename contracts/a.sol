/**
 *Submitted for verification at Arbiscan on 2023-03-21
*/
...
contract PrivateExchangePoolOG is Ownable,Pausable {
    ...
    uint256 public _fee;
    uint256[] public validNumbers = [25, 50, 75, 100, 125, 150, 175, 200];
	...
	*/
    ...
    require(isValidNumber(fee/_fee), "invalid input");
